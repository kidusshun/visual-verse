...
const CreatePin = ({user}) => {
  ...
  return (
    <div className='flex flex-col justify-center items-centermt-5 lg:h-4/5'>
      ...
      <div className='flex lg:flex-row flex-col jutify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
          ...
          <div className='flex flex-col'>
            ...
            <div className='flex justify-end items-end mt-5'>
              <button
                type='button'
                onClick={savePin}
                className='bg-red-500 text-white font-bold p-2 rounded-full w-28 outline'
              >
                Save pin
              </button>
            </div>
