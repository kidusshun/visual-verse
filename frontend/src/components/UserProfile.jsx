...
const randomImage = 'https://source.unsplash.com/1600x900/?nature,photography,technology,workout,money'
        ...
        <div className='relative flex flex-col mb-7'>
          <div className='flex flex-col justify-center items-center'>
            ...
            <img 
              src={user.image}
              alt="profile-image"
              className='rounded-full w-20 -mt-10 h-20 shadow-xl object-cover'
            />
            ...
            <div className='absolute top-0 z-1 right-0 p-2'>
              {userId === user._id && (
                <button
                type='button'
                className='bg-white p-2 border-2 rounded-full cursor-pointer outline-none shadow-md'
                onClick={() => {
                  googleLogout();
                }}
              >
